"""Seed data helper used by tests and migrations."""
...
def seed_reservations(db: Session) -> None:
    ...
    reservations = [
        ...
        ReservationORM(
            id="RES-D4E5F6",
            car_id=3,
            customer_name="Carlos Martínez Ruiz",
            email="carlos.mtz@email.com",
            phone="+34 698 765 432",
            pickup_date="2026-05-14",
            return_date="2026-05-16",
            pickup_location="Oficina Castellón Centro",
            total_price=170,
            status="en_curso",
            payment_status="paid",
        ...
        ReservationORM(
            id="RES-G7H8I9",
            car_id=5,
            customer_name="Laura Fernández Díaz",
            email="laura.fd@email.com",
            phone="+34 655 112 233",
            pickup_date="2026-04-01",
            return_date="2026-04-05",
            pickup_location="Estación AVE Valencia",
            total_price=128,
            status="completada",
            payment_status="paid",
